 ...
 * @Last Modified time: 2023-01-04 13:06:01
 */
...
function crb_attach_theme_options() {
    ...
    ->set_icon( 'dashicons-sos' )
      ->add_tab( __( 'General' ), array(
        ...
        Field::make( 'checkbox', 'crb_update_login_link', 'Update login page image link URL - This will redirect it to the clients Home URL instead of Wordpress' )
        ->set_option_value( 'yes' ),
        ) )
